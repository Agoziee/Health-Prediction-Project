...
public partial class Seaech : System.Web.UI.Page
{
    ...
    {
        SqlDataAdapter da = new SqlDataAdapter("Select DName from Disease Where Sym LIKE '%" + s1 + "%' OR  Sym LIKE '%" + s2 + "%' OR Sym LIKE '%" + s3 + "%' OR Sym LIKE '%" + s4 + "%' OR Sym LIKE '%" + s5 + "%'", con);
        con.Open();
    ...
    {
        SqlDataAdapter da = new SqlDataAdapter("Select DName from Disease Where Sym LIKE '%" + s1 + "%' OR  Sym LIKE '%" + s2 + "%' OR Sym LIKE '%" + s3 + "%' OR Sym LIKE '%" + s4 + "%'", con);
        con.Open();
        DataSet ds = new DataSet();
        da.Fill(ds);
        int row = ds.Tables[0].Rows.Count;
    ...
    {
        SqlDataAdapter da = new SqlDataAdapter("Select DName from Disease Where Sym LIKE '%" + s1 + "%' OR  Sym LIKE '%" + s2 + "%' OR Sym LIKE '%" + s3 + "%'", con);
        con.Open();
        DataSet ds = new DataSet();
        da.Fill(ds);
        int row = ds.Tables[0].Rows.Count;
    ...
    {
        SqlDataAdapter da = new SqlDataAdapter("Select DName from Disease Where Sym LIKE '%" + s1 + "%' OR  Sym LIKE '%" + s2 + "%'", con);
        con.Open();
        DataSet ds = new DataSet();
        da.Fill(ds);
        int row = ds.Tables[0].Rows.Count;
    ...
    {
        SqlDataAdapter da = new SqlDataAdapter("Select DName from Disease Where Sym LIKE '%" + s1 + "%'", con);
        con.Open();
        DataSet ds = new DataSet();
        da.Fill(ds);
        int row = ds.Tables[0].Rows.Count;
